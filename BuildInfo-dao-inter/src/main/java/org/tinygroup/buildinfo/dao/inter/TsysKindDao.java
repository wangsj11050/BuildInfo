 ...
 * <!-- end-user-doc -->
 */
public interface TsysKindDao extends BaseDao<TsysKind, String> {

	List getKindTree(TreeData tree);

	Pager<TsysKind> queryPagerForSearch(int start, int limit, TsysKind t, OrderBy... orderArgs);
	
	List checkExist(TsysKind t);
}
