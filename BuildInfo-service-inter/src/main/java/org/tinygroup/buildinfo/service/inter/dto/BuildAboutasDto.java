...
public class BuildAboutasDto implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5094152799745360920L;
	 ...
	 * <!-- begin-user-doc --> 企业简介内容 * <!-- end-user-doc -->
	 */
	public void setAboutasContent(String aboutasContent) {
		this.aboutasContent = aboutasContent;
	}

	public String getAboutasContent() {
		return aboutasContent;
	}
