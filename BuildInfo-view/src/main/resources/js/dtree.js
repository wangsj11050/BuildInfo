...
function dTree(objName) {
	...
	this.icon = {
		root				: contextPath+'/images/img/base.gif',
		folder			: contextPath+'/images/img/folder.gif',
		folderOpen	: contextPath+'/images/img/folderopen.gif',
		node				: contextPath+'/images/img/page.gif',
		empty				: contextPath+'/images/img/empty.gif',
		line				: contextPath+'/images/img/line.gif',
		join				: contextPath+'/images/img/join.gif',
		joinBottom	: contextPath+'/images/img/joinbottom.gif',
		plus				: contextPath+'/images/img/plus.gif',
		plusBottom	: contextPath+'/images/img/plusbottom.gif',
		minus				: contextPath+'/images/img/minus.gif',
		minusBottom	: contextPath+'/images/img/minusbottom.gif',
		nlPlus			: contextPath+'/images/img/nolines_plus.gif',
		nlMinus			: contextPath+'/images/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
